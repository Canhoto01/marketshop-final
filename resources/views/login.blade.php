        ...
        <div class="p-4 sm:p-7">
          ...
          <div class="mt-5">
            ...
            <form action="{{route('logar')}}" method="POST">
              ...
              <div class="hidden md:block md:absolute md:top-0 md:start-1/2 md:end-0 h-full bg-[url('https://www.koncili.com/wp-content/uploads/2022/03/categorias-do-mercado-livre.webp')] bg-no-repeat bg-center bg-cover"></div>
              <!-- End Col -->
          </div>
            </form>
            <!-- End Form -->
